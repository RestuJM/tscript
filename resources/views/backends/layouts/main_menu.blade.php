<div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="icon-options-vertical"></i><span class="menu-title"
            ...
            <li class=" nav-item"><a href="page-pricing.html"><i class="icon-notebook"></i><span class="menu-title"
                        data-i18n="nav.page-pricing">Pricing page</span></a>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="icon-screen-desktop"></i><span class="menu-title"
            ...
            <li class=" nav-item"><a href="#"><i class="icon-cloud-upload"></i><span class="menu-title"
            ...
            <li class=" nav-item"><a href="#"><i class="icon-social-google"></i><span class="menu-title"
            ...
            <li class=" nav-item"><a href="#"><i class="icon-control-pause"></i><span class="menu-title"
                        data-i18n="nav.dimple_charts.main">Dimple Charts</span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="icon-location-pin"></i><span class="menu-title"
            ...
            <li class=" nav-item"><a href="https://pixinvent.com/robust-bootstrap-admin-template/documentation"><i
