    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <p>Total paid invoices 240, unpaid 150. <span class="float-right"><a href="project-summary.html"
                                    target="_blank">Invoice Summary <i class="ft-arrow-right"></i></a></span></p>
                    </div>
                        ...
                        <table id="recent-orders" class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate"><span class="tag tag-default tag-warning">Overdue</span>
                                    </td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-4 col-sm-12">
                                        <div class="media">
                                            <div class="media-body">
                                                <span>Total Orders <i class="ft-arrow-down deep-orange accent-3"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tweet-slider">
                            <ul class="text-center">
                                ...
                                <li>Puns, humor, and quotes are great content on <span class="yellow">#Twitter</span>. Find
                                    some related to your
                                    business.</li>
